import { Box, Button, filter, Grid, Heading, HStack, Icon, Image, Input, SimpleGrid, Text, VStack } from "@chakra-ui/react"
...
import MenuSection from "../Components/SingleMenuPage/MenuSection"
...
import {fetchProductData} from "../Redux/ProductRedux/product.action.js"
...
export const Menu=()=>{
    ...
    const searchMenus=(e)=>{
        ...
        let query=q.toLowerCase()
            ...
            let title;
            // let p="Hello worlD & hello Universe".replace(/[^a-zA-Z0-9]+/ig, "")
            // let s="Hello worlD & hello Universe".replace(/\s/g, "_")
            // console.log(p,s)
        ...
        <Box bg="white" onClick={hideResults}>
            ...
            {/* /* Menu-sections */ }
                         {/* <ExclusiveDeals 
                            ...
                            endPoint="search/?q=Smoky%20Grilled%20Biryani%20Combo"
                            menuName="EXCLUSIVE_DEAL">
                        </ExclusiveDeals> */}
                        
                        {/* <ExclusiveDeals 
                            title="EXCLUSIVE DEAL" 
                            endPoint="search/?q=Popcorn%20Biryani%20Box"
                            menuName="EXCLUSIVE_DEAL">
                        </ExclusiveDeals> */}
