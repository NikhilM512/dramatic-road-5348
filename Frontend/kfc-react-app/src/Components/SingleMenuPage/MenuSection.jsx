...
const MenuSection = ({title,endPoint,menuName}) => {
   
   let temp=`${menuName}_Data`
const data=useSelector((store)=>{
console.log("DATA",store.product,store.product.EXCLUSIVE_DEAL_Data,temp
    )
    let res=`${temp}`
 return store.product.temp })
const dispatch=useDispatch()
console.log(data)

useEffect(()=>{
    // console.log(title,menuName,endPoint)
